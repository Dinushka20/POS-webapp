        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockAuditLogs_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockAuditLogs_Products_ProductId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Colombo", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), true, "Main Branch" },
                    { 2, "Kandy", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), true, "Branch 2" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockAuditLogs_BranchId",
                table: "StockAuditLogs",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_StockAuditLogs_ProductId",
                table: "StockAuditLogs",
                column: "ProductId");
